document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".q-k-navigation-list");
  const headerRef = document.querySelector(".q-k-header");
  const navigationRef = document.querySelector(".q-k-navigation");
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".q-k-toggle-button img");
